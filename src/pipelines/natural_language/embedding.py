...
#
# from src.utils import , get_emb_params, setup_logging
#
#
# def get_sentences(data: pd.DataFrame, feature: str) -> list:
...
#         self.logger.info("Words-Embedding...")
...
#         sentences = get_sentences(data, feature)
